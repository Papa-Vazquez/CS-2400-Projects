...
public class Main extends MaxHeap<String> 
{
  public static void main(String[] args) throws IOException 
  {
    ...
    Scanner scannerForS = new Scanner(new File("/Users/Emaster360/Downloads/Archive/data_random.txt"));
    ...
    Scanner scannerForSeqSor = new Scanner(new File("/Users/Emaster360/Downloads/project 4/bin/proj4/data_sorted.txt"));
